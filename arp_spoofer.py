...
def get_arguments():
    ...
    if not options.target_ip:
        ...
        parser.error("[-] Please specify a gateway/router ip, use --help for more information.")
    return options
...
try:
    ...
    print("Use CTRL + C to quit application.")
    while True:
    ...
    print("The ARP table has been restored. Exiting...")
